...
BACKUP_DIR = BASE_DIR / "backup_subrealm_final" / datetime.now().strftime("%Y%m%d_%H%M%S")
...
SUB_PATTERNS = {
    ...
    "مرتع و آبخیزداری": [0.45, 0.50, 0.70, 0.65, 0.55],
    "منابع طبیعی": [0.48, 0.52, 0.68, 0.60, 0.58],
    "علوم دامی": [0.42, 0.55, 0.75, 0.65, 0.52],
    "شیلات": [0.40, 0.55, 0.75, 0.62, 0.55],
    "باغبانی": [0.45, 0.52, 0.72, 0.60, 0.62],
    "کشاورزی": [0.42, 0.55, 0.78, 0.65, 0.55],
    
    # محیط زیست و بهداشت
    "بیوسیستم": [0.48, 0.65, 0.72, 0.68, 0.58],
    "محیط زیست": [0.60, 0.58, 0.65, 0.70, 0.68],
    "بهداشت محیط": [0.55, 0.58, 0.75, 0.78, 0.52],
    
    # ایمنی و بازرسی
    "ایمنی و بازرسی": [0.42, 0.55, 0.82, 0.95, 0.40],
    
    # نقشه‌برداری و ژئوماتیک
    "ژئوماتیک": [0.22, 0.82, 0.92, 0.78, 0.52],
    "نقشه‌برداری": [0.22, 0.80, 0.92, 0.78, 0.52],
