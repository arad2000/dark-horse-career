// frontend/app.js — نسخهٔ نهایی و کامل (V25.2)
// شامل: Manifesto، Guide، Splash، سه حلقه، سوایپ، لایه دوم و سوم، تحلیل سبک،
// سناریوهای همسویی هوشمند (با اصلاح سناریوی ۴)، نظرسنجی ۱۰ سوالی،
// دکمهٔ مشاهده بازخوردها، ذخیره خودکار، دکمهٔ ادامه در Splash
...
function renderGuide() {
  app.innerHTML = `
    <div style="text-align:right;padding:10px;">
      ...
      <p style="color:#b0a080;line-height:2.2;">این یک تست شخصیت نیست — بلکه <strong>سفری اکتشافی</strong> به درون خودت است. پس با دقت و آرامش پیش برو.</p>
      
      <div class="card" style="margin-top:15px;">
        <p style="color:#f0c040;font-weight:bold;">🧩 مسیر سفرت چگونه است؟</p>
        <p style="color:#b0a080;line-height:2.2;">این سفر سه لایه دارد که هر کدام یک بُعد از فردیت تو را کشف می‌کند:</p>
        <p style="color:#b0a080;line-height:2.2;"><strong style="color:#f0c040;">۱. لایهٔ اول: خرده‌انگیزه‌ها (۶۰٪ امتیاز نهایی)</strong><br>
        ...
        <p style="color:#d4af37;line-height:2.2;">🎯 <strong>پاسخ واقعی تو در این لایه، فقط و فقط خرده‌انگیزه‌هایی (جرقه‌های انرژی) هستند که ❤️ می‌زنی.</strong> انتخاب‌های قبلی فقط برای این بوده که به این جرقه‌ها برسی. نتیجهٔ نهایی بر اساس همین جرقه‌ها ساخته می‌شود، نه قلمروها یا زیرقلمروهایی که انتخاب کردی.</p>
      </div>

      <div class="card" style="margin-top:15px;">
        <p style="color:#f0c040;font-weight:bold;">🎯 دربارهٔ جرقه‌های انرژی (خرده‌انگیزه‌ها)</p>
        <p style="color:#b0a080;line-height:2.2;">در بخش جرقه‌ها، فعالیت‌های جزئی‌ای را می‌بینی. <strong>حداقل ۲۰ جرقه و حداکثر ۸۰ جرقه</strong> می‌توانی انتخاب کنی. هرچه جرقه‌های بیشتری بزنی، خودِ واقعی‌ات شفاف‌تر کشف می‌شود.<br><br>
        💡 <strong>پیشنهاد ویژه:</strong> برای اینکه انتخاب‌هایت را بهتر مدیریت کنی، بهتر است ابتدا <strong>یک قلمرو را کامل تمام کنی</strong> (از انتخاب زیرقلمرو تا زدن جرقه‌هایش)، بعد برگردی سراغ قلمرو بعدی. اینطوری با انبوهی از گزینه‌های متفاوت روبرو نمی‌شوی و می‌توانی خرده‌انگیزه‌های واقعی هر حوزه را دقیق‌تر کشف کنی.</p>
      </div>

      <div class="card" style="margin-top:15px;">
        <p style="color:#f0c040;font-weight:bold;">🧭 لایهٔ دوم: راهبردهای فردی (۲۰٪ امتیاز)</p>
        <p style="color:#b0a080;line-height:2.2;">در این بخش، ۲۰ موقعیت واقعی پیش روی توست که سبک حل مسئله، یادگیری، کار تیمی و تصمیم‌گیری‌ات را می‌سنجد. هیچ پاسخ درست یا غلطی وجود ندارد — فقط مسیرهای متفاوت.</p>
        
        <p style="color:#f0c040;font-weight:bold;margin-top:10px;">⚖️ لایهٔ سوم: ارزش‌های بنیادین (۲۰٪ امتیاز)</p>
        <p style="color:#b0a080;line-height:2.2;">در این بخش، ۱۰ دوگانهٔ قدرتمند پیش روی توست که نشان می‌دهد چه چیزی واقعاً به کار و زندگی‌ات معنا می‌دهد.</p>
      </div>

      <div class="card" style="margin-top:15px;">
        <p style="color:#f0c040;font-weight:bold;">⏳ چند نکتهٔ حیاتی</p>
        <p style="color:#b0a080;line-height:2.2;">۱. <strong>فضایی آرام انتخاب کن.</strong> جایی که سکوت باشد و کسی مزاحمت نشود.<br>
      ...
      <p style="color:#d4af37;text-align:center;margin-top:20px;"><strong>حالا با خیال راحت، سفرت را شروع کن...</strong></p>
...
function resumeJourney() {
  if (loadSession()) { if (state.stage === 'results' || state.stage === 'splash' || state.stage === 'manifesto' || state.stage === 'guide') state.stage = 'realm'; render(); }
}
...
function getDomainFromStyle(style) {
  const map = {
    'تحلیلی و گام‌به‌گام': ['علوم پایه', 'مهندسی', 'حقوق', 'پزشکی', 'علوم انسانی'],
    'آزمایشگر و جهشی': ['کارآفرینی', 'طراحی', 'علوم تجربی', 'فناوری'],
    'مشورتی و اجتماعی': ['علوم انسانی', 'مشاوره', 'مددکاری', 'آموزش'],
    'شهودی و جرقه‌ای': ['هنر', 'معماری', 'روزنامه‌نگاری', 'طراحی', 'ادبیات'],
...
function getDomainFromValues(valueSummary) {
  ...
  keywords.forEach(kw => {
    ...
    if (kw.includes('زیبایی') || kw.includes('خلق')) domains.add('علوم انسانی').add('هنر').add('ادبیات');
  });
  if (domains.size === 0) return ['علوم انسانی', 'مهندسی', 'هنر'];
  return [...domains].slice(0, 4);
}

function getDomainFromMajorName(name) {
  const map = {
    'پزشکی': ['علوم پزشکی'], 'دندانپزشکی': ['علوم پزشکی'], 'داروسازی': ['علوم پزشکی'],
    'پرستاری': ['علوم پزشکی'], 'مامایی': ['علوم پزشکی'], 'فیزیوتراپی': ['علوم پزشکی'],
    'مهندسی برق': ['مهندسی'], 'مهندسی مکانیک': ['مهندسی'], 'مهندسی عمران': ['مهندسی'],
    'مهندسی کامپیوتر': ['مهندسی', 'فناوری'], 'مهندسی صنایع': ['مهندسی', 'مدیریت'],
    'حقوق': ['علوم انسانی', 'حقوق'], 'علوم سیاسی': ['علوم انسانی', 'علوم سیاسی'],
    'روانشناسی': ['علوم انسانی', 'روانشناسی', 'مشاوره'],
    'علوم ارتباطات': ['علوم انسانی', 'روزنامه‌نگاری'],
    'روزنامه‌نگاری': ['علوم انسانی', 'روزنامه‌نگاری'],
    'مددکاری اجتماعی': ['علوم انسانی', 'مددکاری'],
    'مشاوره': ['علوم انسانی', 'مشاوره'],
    'آموزش ابتدایی': ['علوم انسانی', 'آموزش'],
    'حسابداری': ['علوم انسانی', 'مدیریت'],
    'مدیریت بازرگانی': ['علوم انسانی', 'مدیریت'],
    'اقتصاد': ['علوم انسانی'],
    'معماری': ['هنر', 'مهندسی'],
    'طراحی گرافیک': ['هنر', 'طراحی'],
    'نقاشی': ['هنر'],
    'زبان و ادبیات انگلیسی': ['علوم انسانی', 'ادبیات'],
    'ریاضیات': ['علوم پایه'],
    'فیزیک': ['علوم پایه'],
    'شیمی': ['علوم پایه'],
    'زیست‌شناسی': ['علوم پایه'],
  };
  return map[name] || ['علوم انسانی'];
}
    ...
    matched.forEach(r => {
      ...
      if (r.evidence && typeof r.evidence === 'object') {
        ...
        if (hasStrategy && hasValue && isMicroWeak && bestMajor && r.major_id !== bestMajor.major_id) {
          ...
          scenarioText = `⚡ سبک فکری و ارزش‌هایت با این رشته همسو هستند، اما خرده‌انگیزه‌هایت (فعالیت‌های جزئی که به تو انرژی می‌دهند) بیشتر به سمت «${bestMicroDesc}» اشاره دارند — برای همین «${bestMajor.major_name_fa}» در صدر نشسته است. اگر خرده‌انگیزه‌های بیشتری از این حوزه بزنی، جایگاه این رشته تغییر خواهد کرد.`;
          ...
          // اصلاح سناریوی ۴: فقط اگر رشته با سبک/ارزش کاربر همخوانی نداشته باشد، پیشنهاد اضافی بده
          const majorDomain = getDomainFromMajorName(r.major_name_fa);
          const styleDomains = strategyStyle ? getDomainFromStyle(strategyStyle.style) : [];
          const valueDomains = valueStyle ? getDomainFromValues(valueStyle.summary) : [];
          const isStyleAligned = styleDomains.some(d => majorDomain.includes(d));
          const isValueAligned = valueDomains.some(d => majorDomain.includes(d));

          if (!isStyleAligned && !isValueAligned) {
            if (strategyStyle && valueStyle) {
              const combined = [...new Set([...styleDomains, ...valueDomains])].slice(0, 3).join('، ');
              if (combined) suggestionText += ` بر اساس پاسخ‌هایت، سبک فکری «${strategyStyle.style}» و ارزش‌های «${valueStyle.summary}» در تو قوی‌تر است. شاید علاقه‌مند باشی حوزه‌های ${combined} را نیز بررسی کنی.`;
            } else if (strategyStyle) {
              const sd = styleDomains.slice(0, 3).join('، ');
              if (sd) suggestionText += ` بر اساس پاسخ‌هایت، سبک فکری «${strategyStyle.style}» در تو قوی‌تر است. شاید علاقه‌مند باشی حوزه‌های ${sd} را نیز بررسی کنی.`;
            } else if (valueStyle) {
              const vd = valueDomains.slice(0, 3).join('، ');
              if (vd) suggestionText += ` بر اساس پاسخ‌هایت، ارزش‌های «${valueStyle.summary}» در تو قوی‌تر است. شاید علاقه‌مند باشی حوزه‌های ${vd} را نیز بررسی کنی.`;
            }
          }
      ...
      if (r.evidence && typeof r.evidence === 'object') {
        ...
        const strategyMatch = r.evidence.strategy_matched || r.evidence.strategy_match || [];
        const valueMatch = r.evidence.value_matched || r.evidence.value_match || [];
        if (microMatch.length) parts.push(`🧩 خرده‌انگیزه‌های هم‌راستا: ${microMatch.slice(0,3).map(m=>m.description||m).join('، ')}`);
  ...
  feedbackData.forEach(fb => {
    ...
    html += `
      <div class="card" style="text-align:right;margin-bottom:15px;">
        ...
        <p style="color:#f0c040;">۱۰. پیشنهاد بهبود: ${fb.feedback?.q9 || 'ندارد'}</p>
      </div>`;
  });
