    ...
    <div style="text-align:center;padding:20px;">
      ...
      <div class="card">
        <p style="color:#b0a080;line-height:2.2;font-size:0.95rem;">
          این اپلیکیشن بر اساس پژوهش <strong style="color:#f0c040;">Dark Horse Project</strong> در دانشگاه هاروارد و کتاب <strong style="color:#f0c040;">«اسب سیاه»</strong> نوشتهٔ <strong>تاد رز</strong> و <strong>اگی اوگاس</strong> ساخته شده است.
        </p>
        <p style="color:#b0a080;line-height:2.2;font-size:0.95rem;margin-top:15px;">
          نویسندگان معتقدند بیشتر مردم قربانی یک <strong>«فرمول استاندارد موفقیت»</strong> هستند: درس بخوان، دانشگاه خوب برو، شغل معتبر پیدا کن، ترفیع بگیر، بازنشسته شو. اما این مسیر برای بسیاری نه شادی می‌آورد و نه شکوفایی.
        </p>
        <p style="color:#d4af37;line-height:2.2;font-size:0.95rem;margin-top:15px;">
          <strong>پاسخ آنها: موفقیت واقعی از تقلید دیگران به دست نمی‌آید، بلکه از شناخت دقیق فردیت و ساختن مسیر شخصی حاصل می‌شود.</strong>
        </p>
        <p style="color:#b0a080;line-height:2.2;font-size:0.95rem;margin-top:15px;">
          چهار ستون ذهنیت «اسب سیاه» که در این اپلیکیشن پیاده‌سازی شده:
        </p>
        <p style="color:#b0a080;line-height:2.2;font-size:0.95rem;">
          🧩 <strong style="color:#f0c040;">خرده‌انگیزه‌هایت را بشناس:</strong> نه «به چه چیزی علاقه داری؟»، که «دقیقاً چه فعالیت‌هایی به تو انرژی می‌دهند؟»
        </p>
        <p style="color:#b0a080;line-height:2.2;font-size:0.95rem;">
          🧭 <strong style="color:#f0c040;">راهبردهایت را کشف کن:</strong> بهترین روش یادگیری و رشد برای تو چیست؟ نه نسخهٔ دیگران.
        </p>
        <p style="color:#b0a080;line-height:2.2;font-size:0.95rem;">
          ⚖️ <strong style="color:#f0c040;">ارزش‌هایت را بفهم:</strong> چه چیزی به کارت معنا می‌دهد؟
        </p>
        <p style="color:#b0a080;line-height:2.2;font-size:0.95rem;">
          🛤️ <strong style="color:#f0c040;">مقصد را فراموش کن:</strong> نقشهٔ از پیش تعیین‌شده را کنار بگذار. بهترین قدم بعدی را بردار.
        </p>
        <p style="color:#d4af37;line-height:2.2;font-size:0.95rem;margin-top:15px;">
